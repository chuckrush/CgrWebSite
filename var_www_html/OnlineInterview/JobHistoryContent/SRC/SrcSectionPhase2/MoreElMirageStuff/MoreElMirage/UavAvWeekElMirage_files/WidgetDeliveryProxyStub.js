...
// BLOGBURST_HOST_URL       - The Url of the article hosting the widget (crawled to populate contextual widget channels).
//
// -- QueryString Parameter Names --
// bbTransport              - Transport Type (proxy,css);
...
BlogBurstWidgetProxy.prototype.GetWidget = function(widgetId, hostUrl)
{
    //Create the QueryString items for our Requests
    var appendUrl = this.__GetArgument("bbWidgetId", widgetId, true, false) + this.__GetArgument("bbPostId", this.GetParameter("bbPostId"), false, false) + this.__GetArgument("bbHostUrl", this.EnsureHostUrl(hostUrl), true, false);
...
BlogBurstWidgetProxy.prototype.EnsureHostUrl = function(hostUrl)
{
    if (typeof(hostUrl) == "undefined" || hostUrl == null || hostUrl == "" || this.IsInvalidUrl(hostUrl)) {
...
BlogBurstWidgetProxy.prototype.IsInvalidUrl = function(url)
{
    // quick sanity check
    return url.search(/^http/i) != 0;
};
...
// Make sure (optional) BLOGBURST_TRACKING_CODE global is defined
if (typeof(BLOGBURST_TRACKING_CODE) == "undefined") BLOGBURST_TRACKING_CODE = "";

// Make sure (optional) BLOGBURST_HOST_URL global is defined
if (typeof(BLOGBURST_HOST_URL) == "undefined") BLOGBURST_HOST_URL = "";

//Create Global Proxy Object
var gBlogBurstWidgetProxy = new BlogBurstWidgetProxy(BLOGBURST_PROXY_URL);
gBlogBurstWidgetProxy.GetWidget(BLOGBURST_WIDGET_ID, BLOGBURST_HOST_URL);
